...
public abstract class BaseDAO<T> {
        ...
        try {
            ...
            if(field!=null){
                ...
                if (isMyType(typeName)){
                    ...
                    Constructor<?> constructor = typeClass.getDeclaredConstructor(Integer.class);
                    propertyValue = constructor.newInstance(propertyValue);
                }
                if (propertyValue.getClass().getName().equals("java.time.LocalDateTime")){
                    propertyValue = new Date(((LocalDateTime)propertyValue).atZone(ZoneId.systemDefault()).toInstant().toEpochMilli());
                }
    ...
    private static boolean isNotMyType(String typeName){
        return "java.lang.Integer".equals(typeName)
                ...
                || "java.util.Timestamp".equals(typeName)
                || "java.time.LocalDateTime".equals(typeName)
                || "java.time.Double".equals(typeName);
    }
